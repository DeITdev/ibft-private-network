// compile-company-contract.js - Fixed for Besu compatibility
const fs = require('fs');
...
// Target contract
const contractName = 'CompanyStorage.sol';
...
if (!fs.existsSync(contractPath)) {
  ...
  console.error('Please make sure you have created the CompanyStorage.sol file in the contracts/Company directory');
  process.exit(1);
}
