// compile-attendance-contract.js - Fixed for Besu compatibility
const fs = require('fs');
...
// Target contract
const contractName = 'AttendanceStorage.sol';
...
if (!fs.existsSync(contractPath)) {
  ...
  console.error('Please make sure you have created the AttendanceStorage.sol file in the contracts/HR directory');
  process.exit(1);
}
...
console.log('2. Deploy via Postman using /deploy endpoint with contractType: "attendance"');
console.log('3. Test attendance contract interactions');