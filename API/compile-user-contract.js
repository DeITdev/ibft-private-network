// compile-user-contract.js - Fixed for Besu compatibility
const fs = require('fs');
...
// Target contract
const contractName = 'UserStorage.sol';
...
if (!fs.existsSync(contractPath)) {
  ...
  console.error('Please make sure you have created the UserStorage.sol file in the contracts directory');
  process.exit(1);
}
